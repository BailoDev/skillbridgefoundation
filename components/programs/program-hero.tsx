  ...
  return (
    <div className={`absolute inset-0 pointer-events-none ${className}`}>
      <svg width="100%" height="100%" className="opacity-[0.03]">
        <defs>
          <pattern id="programs-lines" patternUnits="userSpaceOnUse" width="100%" height="3">
            <line x1="0" y1="0" x2="100%" y2="0" stroke="#1C376B" strokeWidth="1" />
          </pattern>
        </defs>
        <rect width="100%" height="100%" fill="url(#programs-lines)" />
      </svg>
    </div>
  )
}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            A structured 4-Pillar model that takes young people from foundational skills to professional readiness.
          </p>
        </motion.div>
      </div>
    </section>
