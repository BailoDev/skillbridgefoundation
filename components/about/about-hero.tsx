  ...
  return (
    <div className={`absolute inset-0 pointer-events-none ${className}`}>
      <svg width="100%" height="100%" className="opacity-[0.03]">
        <defs>
          <pattern id="about-lines" patternUnits="userSpaceOnUse" width="100%" height="3">
...
export default function AboutHero() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
      ...
      {/* Bridge SVG accent — same as original */}
      <div className="absolute inset-0">
        <svg
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] opacity-[0.03]"
          viewBox="0 0 600 300"
          fill="none"
        >
          <path
      ...
      {/* Logo watermark — ported from HeroSection */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-navy">
            About SkillBridge Foundation
          </h1>
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            We bridge the gap between learning and professional reality by equipping young people
            with skills, clarity and exposure to succeed in a changing world.
          </p>
        </motion.div>
      </div>
    </section>
